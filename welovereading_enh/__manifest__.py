# -*- coding: utf-8 -*-
{
    'name': "welovereading system enhancement",
    'summary': """
        Enhancement for welovereading system.
        """,
    ...
    'version': '12.0.1.0',
    'depends': ['base','purchase','account','material_internal_requisitions','purchase_stock'],

    'data': [
#        'security/ir.model.access.csv',
        'views/purchase_enh.xml',
